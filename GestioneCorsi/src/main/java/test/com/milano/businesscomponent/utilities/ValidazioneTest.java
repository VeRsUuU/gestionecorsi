...
class ValidazioneTest {
	...
	void test() throws DAOException {
		...
		Date[] d = new Date[2];
		GregorianCalendar g = new GregorianCalendar(2021,10,20);
		d[0] = g.getTime();
		GregorianCalendar g2 = new GregorianCalendar(2021,10,10);
		d[1] = g2.getTime();
		
		mappa.put(1, d);
		
		HashMap<String, String> map = Validazione.valida("giovanni", "pierino2", mappa);
