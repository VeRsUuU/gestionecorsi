...
<link rel="stylesheet" type="text/css"
	href="tabledesign/vendor/bootstrap/css/bootstrap.min.css">
<link rel="stylesheet" type="text/css"
	href="tabledesign/fonts/font-awesome-4.7.0/css/font-awesome.min.css">
<link rel="stylesheet" type="text/css"
	href="tabledesign/vendor/animate/animate.css">
<link rel="stylesheet" type="text/css"
	href="tabledesign/vendor/select2/select2.min.css">
<link rel="stylesheet" type="text/css"
	href="tabledesign/vendor/perfect-scrollbar/perfect-scrollbar.css">
...
<body>
	...
	<div class="wrap-table100" style="margin: auto;">
		<h3 align="center">Dati amministratore</h3>
		<br>
				...
				<table>
					<tbody>
						...
						<tr class="row100 body">
							...
							<td class="cell100 column4"><i class="bi bi-circle-fill"
								style="color: green;"></i> Online</td>
						</tr>
						<%
						}
						%>
					...
					<tbody>
						...
						<tr class="row100 body">
							...
							<td class="cell100 column5"><a
								href="elimina.jsp?id=<%=c.getCodCorsista()%>"
	...
	<!-- PULSANTI -->
	<div class="container">
		<a class="btn btn-primary" href="inserisciCorsista.jsp">Inserisci
			corsista <i class="bi bi-plus-lg"></i>
		</a> <a class="btn btn-success text-white"> Visualizza statistiche <i
	...
	<script
		src="tabledesign/vendor/perfect-scrollbar/perfect-scrollbar.min.js"></script>
	<script>
