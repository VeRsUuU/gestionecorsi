		...
		<form action="/<%=application.getServletContextName()%>/inserisciCorsista" method="post">
			<div class="row" style="margin-top: 10px">
				<div class="form-group col-md-6">
					<label for="nome">Nome <input class="form-control"
						type="text" name="nome"
				...
				<div class="col-md-4"
					style="padding-top: 30px; color: red; margin-left: 30px">
			...
			<div class="row">
				<div class="form-group col-md-6">
					<label for="cognome">Cognome <input class="form-control"
			...
			<div class="row">
				<div class="form-check col-md-3" style="margin-left: 30px">
					...
					<input type="checkbox"
						...
						name="numeroCorso" class="form-check-input"
						value="<%=corso.getCod()%>"
				...
				<div class="row" style="margin-bottom: 40px; margin-top: 30px">
					<div class="col-md-4">
						...
						<input value="<%if (request.getAttribute("dataInizio" + corso.getCod()) != null) {
								...
								type="text" name="dataInizio<%=corso.getCod()%>"
					...
					<div class="col-md-4">
						<label for="dataFine<%=corso.getCod()%>">Data fine </label>
						<input value="<%if (request.getAttribute("dataFine" + corso.getCod()) != null) {
											out.print(formato.format(request.getAttribute("dataFine" + corso.getCod())));
										} else {
											out.print(formato.format(corso.getDataFine()));
										}%>"
								type="text" name="dataFine<%=corso.getCod()%>" class="form-control-inline">
					</div>
					<div class="col-md-4">
						<p>
							Costo:
			...
			<div class="row" style="margin: 10px 0 0 20px">
				<div class="form-check form-check-inline">
					<label for="precedenti">Precedenti Formativi <input
						class="form-check-input" type="radio" name="precedenti" value="1"
						checked="checked">Si <input class="form-check-input"
						type="radio" name="precedenti" value="0">No
					</label>
				</div>
			</div>
